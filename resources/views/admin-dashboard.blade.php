...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
        <div>
            ...
            <p class="text-sm text-slate-500" data-welcome-message>
                Manage all publications and platform citations.
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        <div class="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm transition-shadow">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-xs font-semibold text-slate-400 mb-1">Total platform papers</p>
    ...
    <!-- Papers Section -->
    <x-dashboard.papers-section :currentRole="'Admin'" />
